...
//    public var accept: String = "Добавить".localized // The left-most button label
//public var cancel: String? = "Отменить".localized // The optional cancel (right-most) button label
...
//
//extension View {
//  public func alertTextField(isPresented: Binding<Bool>, _ alert: TextAlert) -> some View {
