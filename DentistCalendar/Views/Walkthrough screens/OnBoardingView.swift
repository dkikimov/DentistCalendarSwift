...
//    Feature(image: "calendar", imageColor: .blue, title: "Контролируйте свой график", description: "Создавайте и редактируйте свои записи и записи своих пациентов"),
//    Feature(image: "person.fill", imageColor: .red, title: "Управляйте пациентами", description: "Смотрите историю всех записей пациента с помощью персональной карточки"),
//    Feature(image: "network", imageColor: .indigo, title: "Синхронизируйте данные", description: "Используйте приложение на нескольких устройствах и отслеживайте изменения в реальном времени"),
//    Feature(image: "wifi.slash", imageColor: .systemTeal, title: "Используйте без интернета", description: "Работает даже без доступа к интернету без ограничений в функционале")
//
//]
...
//
//                VStack(alignment: .leading) {
//                    ForEach(featuresList) { feature in
//                        HStack(alignment: .center) {
//                            Image(systemName: feature.image)
//                                .font(.system(size: 50))
//                                .foregroundColor(feature.imageColor)
//                                .equalWidth()
