////
////  AppointmentEditViewModel.swift
////  DentistCalendar
////
...
//}
//
//class AppointmentEditViewModel : ObservableObject {
//    
//    @Published var price = ""
...
//    }
//    func createAppointment(isModalPresented: Binding<Bool>, patientDetailData: PatientDetailViewModel, patient: Patient) {
//        let newAppointment = Appointment(patientID: patientID, patient: patient, toothNumber: Int(toothNumber)!, diagnosis: selectedDiagnosisList.map { String($0.text!) }.joined(separator: ", "), price: Int(price)!, dateStart: strFromDate(date: dateStart), dateEnd: strFromDate(date: dateEnd))
